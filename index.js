...
console.log('task 1', summation(10));
...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(data){
    const lowPops = data.filter(function(item){
  ...
  */
  ...
  function USApop(data){
   const totalPop = data.reduce(function(accumulator, USApop){
      return accumulator + USApop.population
    }, 0);
    return totalPop
  }
...
function greeting(a, b){
  ...
  console.log('task 6a', consume(2, 2, add)); // 4
  console.log('task 6b', consume(10, 16, multiply)); // 160
...
// ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️
console.log('task 7a', cuboid.volume()); // 100
console.log('task 7b', cuboid.surfaceArea()); // 130
...
//🦄🦄🦄 Test your volume and surfaceArea methods by uncommenting the logs below: 🦄🦄🦄
console.log('task 8a', cuboidTwo.volume()); // 100
console.log('task 8b', cuboidTwo.surfaceArea()); // 130
